...
python -m nmt.nmt --vocab_prefix=nmt/nmt_data/vocab  --train_prefix=nmt/nmt_data/train  --dev_prefix=nmt/nmt_data/dev  --test_prefix=nmt/nmt_data/test  --out_dir=nmt/nmt_model_2 --num_train_steps=12000 --steps_per_stats=100 --num_layers=2  --num_units=128  --dropout=0.2 --metrics=bleu --attention_architecture=joint
