...
class JointAttention(_BaseAttentionMechanism):
  ...
  def __init__(self,
    ...
    self.eW_kernel = self.add_variable('eW_kernel',
                                    shape=[self._num_units,memory.shape[-1]],
                                    initializer=None,
                                    regularizer=None,
    ...
    self.dW_kernel = self.add_variable('dW_kernel',
                                    shape=[self.num_units,memory.shape[-1]],
                                    initializer=None,
                                    regularizer=None,
                                    #constraint=self.kernel_constraint,
                                    dtype=self.dtype,
    ...
    self.yW_kernel = self.add_variable('yW_kernel',
                                    shape=[memory.shape[-1],self.vocab_size],
                                    initializer=None,
                                    regularizer=None,
                                    #constraint=self.kernel_constraint,
                                    dtype=self.dtype,
    ...
    self.W1_kernel = self.add_variable('W1_kernel',
                                    shape=[memory.shape[-1],memory.shape[-1].value/2],
                                    initializer=None,
                                    regularizer=None,
                                    #constraint=self.kernel_constraint,
                                    dtype=self.dtype,
    ...
    self.W2_kernel = self.add_variable('W2_kernel',
                                    shape=[memory.shape[-1].value/2,1],
                                    initializer=None,
                                    regularizer=None,
                                    #constraint=self.kernel_constraint,
                                    dtype=self.dtype,
...
class AttentionWrapper_joint(rnn_cell_impl.RNNCell):
  ...
  def __init__(self,
    ...
    **NOTE** If you are using the `BeamSearchDecoder` with a cell wrapped in
    ...
    self.lstm_cell = tf.contrib.rnn.LSTMCell(self.lstm_hidden_units, forget_bias=1.0)
