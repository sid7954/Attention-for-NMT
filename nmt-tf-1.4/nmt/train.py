...
def has_nan(datum, tensor):
  ...
  if (tf_debug.has_inf_or_nan(datum, tensor)):
...
def train(hparams, scope=None, target_session=""):
  ...
  #train_sess, eval_sess, infer_sess = [tf_debug.LocalCLIDebugWrapperSession(sess) for sess in [ train_sess, eval_sess, infer_sess ]]
  #train_sess.add_tensor_filter('has_nan', has_nan)
  #eval_sess.add_tensor_filter('has_nan', has_nan)
  #infer_sess.add_tensor_filter('has_nan', has_nan)
